...
class Comments extends Composer
{
    ...
    public function title()
    {
        return sprintf(
            ...
            _nx('%1$s response to &ldquo;%2$s&rdquo;', '%1$s responses to &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'tolle'),
            get_comments_number() === 1 ? _x('One', 'comments title', 'tolle') : number_format_i18n(get_comments_number()),
            get_the_title()
        );
    }
